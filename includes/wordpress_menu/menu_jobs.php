                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="editor-container">
                                        <textarea id="job_company_info_${jobIndex}" name="job_company_info[]" style="width: 800px; height: 250px;"><?php echo isset($job['job_company_info']) ? esc_textarea($job['job_company_info']) : ''; ?></textarea>
                                    </div>
                                </td>
                            </tr>
                            <!-- Standort -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="krp-text-editor">
                                        ...
                                        <div class="editor-container">
                                            <textarea id="job_tasks_${jobIndex}" name="job_tasks[]" style="width: 800px; height: 250px;">
                                                <?php
                                                                echo (!empty($job) && is_array($job) && isset($job['job_tasks']))
                                                                    ? esc_textarea($job['job_tasks'])
                                                                    : '';
                                                                ?>
                                            </textarea>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="krp-text-editor">
                                        ...
                                        <div class="editor-container">
                                            <textarea id="job_application_${jobIndex}" name="job_application[]" style="width: 800px; height: 250px;"><?php echo isset($job['job_application']) ? esc_textarea($job['job_application']) : ''; ?></textarea>
                                        </div>
                                    </div>
                                </td>
                            </tr>
